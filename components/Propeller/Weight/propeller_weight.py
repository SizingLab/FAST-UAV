...
class ComputePropellerWeightMR(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('data:propeller:reference:diameter_ref', val=np.nan, units='m')
        self.add_input('data:propeller:reference:mass_ref', val=np.nan, units='kg')
    ...
    def compute(self, inputs, outputs):
        ...
        Dpro_ref = inputs['data:propeller:reference:diameter_ref']
        Mpro_ref = inputs['data:propeller:reference:mass_ref']
