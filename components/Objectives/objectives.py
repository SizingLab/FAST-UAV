...
class DefineObjectives(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output('optimization:constraints:cons_mass_convergence', units=None)
        self.add_output('optimization:constraints:cons_flight_autonomy', units=None)
        self.add_output('optimization:constraints:cons_MTOW', units=None)
