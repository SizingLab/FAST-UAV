...
class MotorConstraints(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output('constraints:motor:torque:takeoff', units=None)
        self.add_output('constraints:motor:torque:climb', units=None)
    ...
    def compute(self, inputs, outputs):
        ...
        outputs['constraints:motor:torque:takeoff'] = motor_con1
        outputs['constraints:motor:torque:climb'] = motor_con2
