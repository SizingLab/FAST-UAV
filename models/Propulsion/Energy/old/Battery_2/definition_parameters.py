...
class Weight(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:battery:mass:k", val=np.nan)
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials["data:battery:mass:estimated", "data:battery:mass:k"] = M_load
...
class Capacity(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        C_bat = (
            Mbat / Mbat_ref * Cbat_ref / V_bat * Vbat_ref
        )  # [A.s] Capacity  of the battery
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials["data:battery:capacity:estimated", "data:battery:mass:estimated"] = (
            1 / Mbat_ref * Cbat_ref / V_bat * Vbat_ref
        )

        partials[
            "data:battery:capacity:estimated", "data:battery:voltage:estimated"
        ] = (-Mbat / Mbat_ref * Cbat_ref / V_bat**2 * Vbat_ref)
