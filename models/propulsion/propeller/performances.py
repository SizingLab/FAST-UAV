...
class TakeOff(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        # C_t_sta = inputs["data:propulsion:propeller:aerodynamics:CT:static"]
        # C_p_sta = inputs["data:propulsion:propeller:aerodynamics:CP:static"]
        ...
        outputs["data:propulsion:propeller:speed:takeoff"] = Wpro_to
        outputs["data:propulsion:propeller:torque:takeoff"] = Qpro_to
        outputs["data:propulsion:propeller:power:takeoff"] = Ppro_to
...
class Hover(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        outputs["data:propulsion:propeller:speed:hover"] = Wpro_hover
        outputs["data:propulsion:propeller:torque:hover"] = Qpro_hover
        outputs["data:propulsion:propeller:power:hover"] = Ppro_hover
...
class Climb(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        Dpro = inputs["data:propulsion:propeller:diameter"]
        beta = inputs["data:propulsion:propeller:beta"]
        J_cl = inputs["data:propulsion:propeller:advance_ratio:climb"]
        alpha = inputs["mission:design_mission:climb:AoA"]
        F_pro_cl = inputs["data:propulsion:propeller:thrust:climb"]
        rho_air = inputs["mission:design_mission:climb:atmosphere:density"]

        # C_t_axial = inputs["data:propulsion:propeller:aerodynamics:CT:axial"]
        # C_p_axial = inputs["data:propulsion:propeller:aerodynamics:CP:axial"]
        ...
        outputs["data:propulsion:propeller:speed:climb"] = Wpro_cl
        outputs["data:propulsion:propeller:torque:climb"] = Qpro_cl
        outputs["data:propulsion:propeller:power:climb"] = Ppro_cl
...
class Cruise(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        F_pro_cr = inputs["data:propulsion:propeller:thrust:cruise"]
        ...
        # C_t_inc = inputs["data:propulsion:propeller:aerodynamics:CT:incidence"]
        # C_p_inc = inputs["data:propulsion:propeller:aerodynamics:CP:incidence"]
        ...
        outputs["data:propulsion:propeller:speed:cruise"] = Wpro_cr
        outputs["data:propulsion:propeller:torque:cruise"] = Qpro_cr
        outputs["data:propulsion:propeller:power:cruise"] = Ppro_cr
