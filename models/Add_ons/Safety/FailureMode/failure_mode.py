...
class MotorDegradedPerfos(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('addons:safety:rotor_fail', val=np.nan, units=None)
        self.add_input('addons:safety:k_uneven', val=np.nan, units=None)
        self.add_input('data:system:MTOW', val=np.nan, units=None)
        self.add_input('data:mission_design:air_density', val=np.nan, units=None)
        ...
        self.add_output('addons:safety:motor_constraint:hover', units=None)
    ...
    def compute(self, inputs, outputs):
        ...
        Npro_fail = inputs['addons:safety:rotor_fail']
        k_asym = inputs['addons:safety:k_asym']  # [-] even-to-uneven thrust oversizing ratio to maintain axis controllability
        ...
        outputs['addons:safety:motor_constraint:hover'] = motor_con_hover
