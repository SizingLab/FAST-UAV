...
class Base(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        rho_air = AtmosphereSI(
            altitude_FF, dISA
        ).density  # [kg/m3] Air density at cruise level
...
class Forward(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        S_ref = S_top_estimated * np.sin(alpha) + S_front_estimated * np.cos(
            alpha
        ...
        outputs["mission:design_mission:forward:angle"] = alpha
