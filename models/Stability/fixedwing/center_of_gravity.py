...
class CoG_fuselage(om.ExplicitComponent):
    ...
    def setup(self):
        self.add_input("data:airframe:fuselage:length:nose", val=np.nan, units="m")
        self.add_input("data:airframe:fuselage:length:mid", val=np.nan, units="m")
        self.add_input("data:airframe:fuselage:length:rear", val=np.nan, units="m")
        self.add_input("data:airframe:fuselage:diameter:mid", val=np.nan, units="m")
        self.add_input("data:airframe:fuselage:diameter:tip", val=np.nan, units="m")
        self.add_input("data:airframe:fuselage:mass:nose", val=np.nan, units="kg")
        self.add_input("data:airframe:fuselage:mass:mid", val=np.nan, units="kg")
        self.add_input("data:airframe:fuselage:mass:rear", val=np.nan, units="kg")
        self.add_input("data:airframe:fuselage:mass", val=np.nan, units="kg")
    ...
    def compute(self, inputs, outputs):
        l_nose = inputs["data:airframe:fuselage:length:nose"]
        l_mid = inputs["data:airframe:fuselage:length:mid"]
        l_rear = inputs["data:airframe:fuselage:length:rear"]
        d_fus_mid = inputs["data:airframe:fuselage:diameter:mid"]
        d_fus_tip = inputs["data:airframe:fuselage:diameter:tip"]
        m_nose = inputs["data:airframe:fuselage:mass:nose"]
        m_mid = inputs["data:airframe:fuselage:mass:mid"]
        m_rear = inputs["data:airframe:fuselage:mass:rear"]
        m_fus = inputs["data:airframe:fuselage:mass"]
...
class CoG_wing(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:airframe:wing:MAC:LE:x", val=np.nan, units="m")
    ...
    def compute(self, inputs, outputs):
        ...
        x_MAC_LE = inputs["data:airframe:wing:MAC:LE:x"]
...
class CoG_ht(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:airframe:tail:horizontal:MAC:LE:x", val=np.nan, units="m")
    ...
    def compute(self, inputs, outputs):
        ...
        x_MAC_LE = inputs["data:airframe:tail:horizontal:MAC:LE:x"]
...
class CoG_vt(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:airframe:tail:vertical:MAC:LE:x", val=np.nan, units="m")
    ...
    def compute(self, inputs, outputs):
        ...
        x_MAC_LE = inputs["data:airframe:tail:vertical:MAC:LE:x"]
...
class CoG_battery(om.ExplicitComponent):
    ...
    def setup(self):
        self.add_input("data:airframe:wing:root:LE:x", val=np.nan, units="m")
    ...
    def compute(self, inputs, outputs):
        x_root_LE_w = inputs["data:airframe:wing:root:LE:x"]
...
class CoG_UAV(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:airframe:fuselage:mass", val=np.nan, units="kg")
        self.add_input("data:airframe:wing:mass", val=np.nan, units="kg")
        self.add_input("data:airframe:tail:horizontal:mass", val=np.nan, units="kg")
        self.add_input("data:airframe:tail:vertical:mass", val=np.nan, units="kg")
