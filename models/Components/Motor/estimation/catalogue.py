...
class MotorCatalogueSelection(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        if self.options["use_catalogue"]:
            ...
            # Outputs
            outputs["data:motor:torque:max"] = outputs[
                "data:motor:torque:max:catalogue"
            ] = Tmax
            outputs["data:motor:torque:coefficient"] = outputs[
                "data:motor:torque:coefficient:catalogue"
            ] = Ktmot
            outputs["data:motor:torque:nominal"] = outputs[
                "data:motor:torque:nominal:catalogue"
            ] = Tnom
            outputs["data:motor:torque:friction"] = outputs[
                "data:motor:torque:friction:catalogue"
            ] = Tfmot
            outputs["data:motor:resistance"] = outputs[
                "data:motor:resistance:catalogue"
            ] = Rmot
        ...
        # CUSTOM COMPONENTS (no change)
            ...
            outputs["data:motor:torque:coefficient"] = inputs[
                "data:motor:torque:coefficient:estimated"
            ]
            outputs["data:motor:torque:nominal"] = inputs[
                "data:motor:torque:nominal:estimated"
            ]
            outputs["data:motor:torque:friction"] = inputs[
                "data:motor:torque:friction:estimated"
            ]
