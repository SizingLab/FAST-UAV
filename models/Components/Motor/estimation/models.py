...
class MotorEstimationModels(om.Group):
    ...
    """
    def setup(self):
        add_subsystem_with_deviation(self, "max_torque", MaxTorque(),
                                     uncertain_outputs={'data:motor:torque:max:estimated': 'N*m'})

        add_subsystem_with_deviation(self, "friction_torque", FrictionTorque(),
                                     uncertain_outputs={'data:motor:torque:friction:estimated': 'N*m'})

        add_subsystem_with_deviation(self, "resistance", Resistance(),
