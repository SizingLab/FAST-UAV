...
class PropellerDefinitionParameters(om.Group):
    ...
    """
    def setup(self):
        add_subsystem_with_deviation(self, "beta", beta(),
...
class SpeedTO(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials['data:propeller:ND:takeoff',
                 'data:propeller:settings:ND:k'] = NDmax
...
class beta(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        outputs['data:propeller:geometry:beta:estimated'] = inputs['data:propeller:geometry:beta:guess']

    def compute_partials(self, inputs, partials, discrete_inputs=None):
        partials['data:propeller:geometry:beta:estimated',
                 'data:propeller:geometry:beta:guess'] = 1.0
