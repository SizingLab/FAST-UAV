...
from models.Uncertainty.uncertainty import add_subsystem_with_deviation, add_model_deviation
...
class PropellerEstimationModels(om.Group):
    ...
    def setup(self):
        ...
        add_subsystem_with_deviation(self, "diameter", Diameter(),
...
class PropellerAerodynamicsModel:
    ...
    init_uncertain_parameters = {'uncertainty:propeller:aerodynamics:CT:static:abs': .0,
                                 'uncertainty:propeller:aerodynamics:CP:static:abs': .0,
                                 'uncertainty:propeller:aerodynamics:CT:axial:abs': .0,
                                 'uncertainty:propeller:aerodynamics:CP:axial:abs': .0,
                                 'uncertainty:propeller:aerodynamics:CT:incidence:abs': .0,
                                 'uncertainty:propeller:aerodynamics:CP:incidence:abs': .0,
                                 'uncertainty:propeller:aerodynamics:CT:static:rel': .0,
                                 'uncertainty:propeller:aerodynamics:CP:static:rel': .0,
                                 'uncertainty:propeller:aerodynamics:CT:axial:rel': .0,
                                 'uncertainty:propeller:aerodynamics:CP:axial:rel': .0,
                                 'uncertainty:propeller:aerodynamics:CT:incidence:rel': .0,
                                 'uncertainty:propeller:aerodynamics:CP:incidence:rel': .0,
                                 }
    ...
    def aero_coefficients_static(beta):
        ...
        delta = PropellerAerodynamicsModel.uncertain_parameters['uncertainty:propeller:aerodynamics:CT:static:abs']
        eps = PropellerAerodynamicsModel.uncertain_parameters['uncertainty:propeller:aerodynamics:CT:static:rel']
        C_t_sta = C_t_sta * (1 + eps) + delta
        delta = PropellerAerodynamicsModel.uncertain_parameters['uncertainty:propeller:aerodynamics:CP:static:abs']
        eps = PropellerAerodynamicsModel.uncertain_parameters['uncertainty:propeller:aerodynamics:CP:static:rel']
    ...
    def aero_coefficients_axial(beta, J):
        ...
        # Deviations (for uncertainty purpose)
        delta = PropellerAerodynamicsModel.uncertain_parameters['uncertainty:propeller:aerodynamics:CT:axial:abs']
        eps = PropellerAerodynamicsModel.uncertain_parameters['uncertainty:propeller:aerodynamics:CT:axial:rel']
        C_t_axial = C_t_axial * (1 + eps) + delta
        delta = PropellerAerodynamicsModel.uncertain_parameters['uncertainty:propeller:aerodynamics:CP:axial:abs']
        eps = PropellerAerodynamicsModel.uncertain_parameters['uncertainty:propeller:aerodynamics:CP:axial:rel']
    ...
    def aero_coefficients_incidence(beta, J, alpha, N_blades=2, chord_to_radius=0.15, r_norm=0.75):
        ...
        # Deviations (for uncertainty purpose)
        delta = PropellerAerodynamicsModel.uncertain_parameters['uncertainty:propeller:aerodynamics:CT:incidence:abs']
        eps = PropellerAerodynamicsModel.uncertain_parameters['uncertainty:propeller:aerodynamics:CT:incidence:rel']
        C_t_inc = C_t_inc * (1 + eps) + delta
        delta = PropellerAerodynamicsModel.uncertain_parameters['uncertainty:propeller:aerodynamics:CP:incidence:abs']
        eps = PropellerAerodynamicsModel.uncertain_parameters['uncertainty:propeller:aerodynamics:CP:incidence:rel']
...
class Aerodynamics(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        C_t_axial, C_p_axial = PropellerAerodynamicsModel.aero_coefficients_axial(beta, J_cl)
        C_t_inc, C_p_inc = PropellerAerodynamicsModel.aero_coefficients_incidence(beta, J_ff, alpha)
