...
class TubeSparFoamModel(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        E_spar = float(inputs["data:structures:wing:spar:material:E"])
        sig_spar = float(inputs["data:structures:wing:spar:material:stress:max"])
        ...
        E_foam = float(inputs["data:structures:wing:foam:E"])
        rho_spar = float(inputs["data:weight:airframe:wing:spar:density"])
        rho_skin = float(inputs["data:structures:wing:skin:material:density"])
        rho_foam = float(inputs["data:structures:wing:foam:density"])

        d_out_root = float(inputs["data:structures:wing:spar:diameter:outer:root"])
        d_out_tip = float(inputs["data:structures:wing:spar:diameter:outer:tip"])
        t_wall_root = float(inputs["data:structures:wing:spar:wall:thickness:root"])
        t_wall_tip = float(inputs["data:structures:wing:spar:wall:thickness:tip"])
        t_face = float(inputs["data:structures:wing:skin:face:thickness"])
