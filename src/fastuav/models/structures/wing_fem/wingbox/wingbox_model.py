...
class WingboxModel(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        mesh = build_wingbox_mesh(
            semi_span=semi_span,
            c_root=float(inputs["data:geometry:wing:root:chord"]),
            c_tip=float(inputs["data:geometry:wing:tip:chord"]),
            h_root=float(inputs["data:geometry:wing:root:thickness"]),
            h_tip=float(inputs["data:geometry:wing:tip:thickness"]),
        ...
        res = solve_wingbox(
            mesh,
            E_skin=float(inputs["data:structures:wing:skin:material:E"]),
            nu=nu,
            rho_skin=float(inputs["data:structures:wing:skin:material:density"]),
            t_skin_root=float(inputs["data:structures:wing:skin:thickness:root"]),
            t_skin_tip=float(inputs["data:structures:wing:skin:thickness:tip"]),
            t_rib=float(inputs["data:structures:wing:ribs:thickness"]),
            rho_rib=float(inputs["data:weight:airframe:wing:ribs:density"]),
            E_cap=float(inputs["data:structures:wing:spar:material:E"]),
            nu_cap=nu,
            rho_cap=float(inputs["data:weight:airframe:wing:spar:density"]),
            A_cap_root=float(inputs["data:structures:wing:spar:cap_area:root"]),
            A_cap_tip=float(inputs["data:structures:wing:spar:cap_area:tip"]),
            sig_skin=float(inputs["data:structures:wing:skin:material:stress:max"]),
            sig_cap=float(inputs["data:structures:wing:spar:material:stress:max"]),
            ...
            t_web_root=float(inputs["data:structures:wing:spar:web_thickness:root"]),
            t_web_tip=float(inputs["data:structures:wing:spar:web_thickness:tip"]),
            E_web=float(inputs["data:structures:wing:spar:material:E"]),
            rho_web=float(inputs["data:weight:airframe:wing:spar:density"]),
            sig_web=float(inputs["data:structures:wing:spar:material:stress:max"]),
            kc_skin=opt["kc_skin"],
