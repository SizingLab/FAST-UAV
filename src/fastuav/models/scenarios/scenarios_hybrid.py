...
from fastuav.models.scenarios.thrust.takeoff import (
    VerticalTakeoffThrust,
    LauncherTakeoff,
)
from fastuav.models.scenarios.thrust.cruise import FixedwingCruiseThrust, NoCruise
from fastuav.models.scenarios.thrust.climb import (
    MultirotorClimbThrust,
    FixedwingClimbThrust,
)
