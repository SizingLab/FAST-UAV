...
class Cd0HorizontalTail(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input("data:geometry:tail:has_T_tail", val=np.nan, units=None)
        ...
        if self.options["low_speed_aero"]:
            ...
            self.add_output("data:aerodynamics:tail:horizontal:cruise:CD0")
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        sweep_25_ht = inputs["data:geometry:tail:horizontal:sweep_25"]
        # wet_area_ht = inputs["data:geometry:horizontal_tail:wet_area"]
        ht_area = inputs["data:geometry:tail:horizontal:surface"]
        has_T_tail = inputs["data:geometry:tail:has_T_tail"]
        ...
        if self.options["low_speed_aero"]:
            ...
            outputs["data:aerodynamics:tail:horizontal:cruise:CD0"] = cd0
