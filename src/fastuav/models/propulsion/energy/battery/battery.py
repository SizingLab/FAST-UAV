...
from fastuav.models.propulsion.energy.battery.estimation_models import (
...
class Battery(om.Group):
    ...
    def setup(self):
        ...
        self.add_subsystem(
            "estimation_models", BatteryEstimationModels(), promotes=["*"]
        )
        self.add_subsystem(
            "catalogue_selection"
        ...
        self.add_subsystem(
            "performance_analysis", BatteryPerformanceGroup(), promotes=["*"]
        )
