...
class PropellerDefinitionParameters(om.Group):
    ...
    def setup(self):
        ...
        add_subsystem_with_deviation(
            ...
            uncertain_outputs={
                "data:propulsion:propeller:Ct:static:polynomial:estimated": None,
...
class TakeOffSpeed(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            "data:propulsion:propeller:ND:takeoff",
            "optimization:variables:propulsion:propeller:ND:k",
        ] = NDmax
...
class AerodynamicsModelParameters(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        outputs["data:propulsion:propeller:Ct:static:polynomial:estimated"] = inputs[
            "models:propulsion:propeller:Ct:static:polynomial"
        ]
        outputs["data:propulsion:propeller:Cp:static:polynomial:estimated"] = inputs[
            "models:propulsion:propeller:Cp:static:polynomial"
        ]
        outputs["data:propulsion:propeller:Ct:dynamic:polynomial:estimated"] = inputs[
            "models:propulsion:propeller:Ct:dynamic:polynomial"
        ]
        outputs["data:propulsion:propeller:Cp:dynamic:polynomial:estimated"] = inputs[
            "models:propulsion:propeller:Cp:dynamic:polynomial"
        ]
