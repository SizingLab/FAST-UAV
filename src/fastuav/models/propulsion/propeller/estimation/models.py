...
class PropellerEstimationModels(om.Group):
    ...
    def setup(self):
        ...
        add_subsystem_with_deviation(
            ...
            "weight",
            Weight(),
            uncertain_outputs={"data:weights:propeller:mass:estimated": "kg"},
        )
...
class Weight(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        Mpro_ref = inputs["data:weights:propeller:mass:reference"]

        Mpro = Mpro_ref * (Dpro / Dpro_ref) ** 3  # [kg] Propeller mass

        outputs["data:weights:propeller:mass:estimated"] = Mpro
...
#         self.add_output("data:propulsion:propeller:aerodynamics:CT:static:estimated", units=None)
#         self.add_output("data:propulsion:propeller:aerodynamics:CP:static:estimated", units=None)
#         self.add_output("data:propulsion:propeller:aerodynamics:CT:axial:estimated", units=None)
#         self.add_output("data:propulsion:propeller:aerodynamics:CP:axial:estimated", units=None)
#         self.add_output(
#             "data:propulsion:propeller:aerodynamics:CT:incidence:estimated", units=None
#         )
#         self.add_output(
#             "data:propulsion:propeller:aerodynamics:CP:incidence:estimated", units=None
#         )
#
#     def setup_partials(self):
#         # Finite difference all partials.
...
#         )
#
#         outputs["data:propulsion:propeller:aerodynamics:CT:static:estimated"] = C_t_sta
#         outputs["data:propulsion:propeller:aerodynamics:CP:static:estimated"] = C_p_sta
#         outputs["data:propulsion:propeller:aerodynamics:CT:axial:estimated"] = C_t_axial
#         outputs["data:propulsion:propeller:aerodynamics:CP:axial:estimated"] = C_p_axial
#         outputs["data:propulsion:propeller:aerodynamics:CT:incidence:estimated"] = C_t_inc
#         outputs["data:propulsion:propeller:aerodynamics:CP:incidence:estimated"] = C_p_inc
