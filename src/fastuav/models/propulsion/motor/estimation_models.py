...
class NominalTorque(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            ...
            "models:propulsion:motor:torque:nominal:reference",
        ] = T_mot_max / T_mot_max_ref

        partials[
            "data:propulsion:motor:torque:nominal:estimated",
            "models:propulsion:motor:torque:max:reference",
        ] = -T_mot_nom_ref * T_mot_max / T_mot_max_ref**2

        partials[
            "data:propulsion:motor:torque:nominal:estimated",
            "data:propulsion:motor:torque:max:estimated",
        ] = T_mot_nom_ref / T_mot_max_ref
...
class Geometry(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        partials[
            "data:propulsion:motor:length:estimated",
